...
- **Languages:** Java (8+, 17), SQL, Python
- **Backend & Architecture:** Spring Boot, Microservices, REST API Design, Spring Cloud (Gateway, Config, Eureka), Spring Security (JWT, RBAC), Spring Data JPA, Feign, Apache Camel, Resilience4j
- **Data & Messaging:** MySQL, PostgreSQL, Redis, Apache Kafka, HikariCP
- **Observability:** OpenTelemetry, Micrometer, Prometheus, Grafana
- **Testing:** JUnit 5, Mockito, Testcontainers
- **DevOps & Tools:** Docker, GitHub Actions, Jenkins, Maven, Git, SonarQube

## Let's Connect

- 📧 [jeysiva.apjs@gmail.com](mailto:jeysiva.apjs@gmail.com)
- 💼 [linkedin.com/in/jeysiva](https://www.linkedin.com/in/jeysiva)
